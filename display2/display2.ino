 ...
 */
  ...
  Bridge = constrain(newBridgePosition,0,110);
 }}
...
void makeDisplay(){
    ...
    display.println("WAH");
     ...
     if (modSel == 5){
    display.println("RING MOD");
    }
     if (modSel == 6){
    display.println("TREMOLO");
    }
     if (modSel == 7){
    display.println("GRANULAR");
    }
     if (modSel == 8){
    display.println("PARAMETRIC");
    }
    ...
    display.display();
    display.setCursor(Neck,17);
    //display.setCursor(0,0);
    display.println(modSel);
    display.display();
}
