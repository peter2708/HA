...
AudioFilterStateVariable preproc;        //xy=188.00000762939453,737.0001010894775
...
AudioAnalyzeNoteFrequency freq;      //xy=319.00001525878906,737.0000381469727
AudioSynthWaveform       waveform2;      //xy=328.99998474121094,783.9999923706055
AudioFilterStateVariable wah;        //xy=434.0000190734863,658.0000324249268
AudioEffectMultiply      multiply2;      //xy=470.0000228881836,777.0000419616699
...
AudioMixer4              mixer2;         //xy=950.9999847412109,692.9999923706055
...
AudioConnection          patchCord1(PUBlend, 0, bassPass, 0);
AudioConnection          patchCord2(PUBlend, 0, midPass, 0);
AudioConnection          patchCord3(PUBlend, 0, mixer1, 0);
AudioConnection          patchCord4(PUBlend, rms1);
AudioConnection          patchCord5(PUBlend, 0, wah, 0);
AudioConnection          patchCord6(PUBlend, 0, mixer2, 0);
AudioConnection          patchCord7(PUBlend, 0, preproc, 0);
AudioConnection          patchCord8(preproc, 1, freq, 0);
...
AudioConnection          patchCord12(dc1, 0, multiply2, 0);
AudioConnection          patchCord13(waveform2, 0, multiply2, 1);
AudioConnection          patchCord14(wah, 1, mixer2, 1);
AudioConnection          patchCord15(multiply2, 0, mixer2, 2);
AudioConnection          patchCord16(bassPass, 0, mixer1, 1);
AudioConnection          patchCord17(midPass, 1, mixer1, 2);
AudioConnection          patchCord18(waveform1, 0, multiply1, 1);
AudioConnection          patchCord19(mixer1, 0, multiply1, 0);
AudioConnection          patchCord20(mixer2, 0, i2s2, 0);
AudioConnection          patchCord21(multiply1, 0, mixer1, 3);
...
float answer = freq.read();

waveform2.begin(1,answer,WAVEFORM_SAWTOOTH);
